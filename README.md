...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-events-content-filament?sort=semver)](https://github.com/liberusoftware/module-cms-events-content-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-events-content-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-events-content-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-events-content-filament
```
...
<a href="https://github.com/liberusoftware/module-cms-events-content-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-events-content-filament" alt="Contributors to liberusoftware/module-cms-events-content-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-events-content-filament/graphs/contributors).
